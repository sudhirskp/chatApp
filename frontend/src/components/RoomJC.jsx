...
//       <div className="p-8 col-auto w-auto max-w-dvw rounded shadow-lg bg-white dark:bg-gray-700">
//          <h1 className="text-2xl col-auto text-gray-800 dark:text-white"><b>Join Or Create the Room</b></h1>
//          <form className="mt-4">
//             <div className="mb-4">
//               <label className="block text-sm font-medium mb-2 text-gray-700 dark:text-gray-300" htmlFor="name">Enter Name:</label>
//               <input
//                  type="text"
//                  id="name"
//                  name="name"
//                  className="w-full px-3 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-600 dark:text-white"
//                  placeholder="Name here"
//               />
//             </div>
//             <div className="mb-4">
//               <label className="block text-sm font-medium mb-2 text-gray-700 dark:text-gray-300" htmlFor="roomId">Enter Room ID:</label>
//               <input
//                  type="text"
//                  id="roomId"
//                  name="roomId"
...
//                     //backgroundImage: "url('https://source.unsplash.com/800x600/?abstract,technology')",
//                     backgroundImage: "url('aug_8_01.jpg')",
//                     backgroundSize: "cover",
//                     backgroundPosition: "right",
//                 }}
//             >
//                 <h1 className="text-2xl col-auto text-gray-900 dark:text-gray-100 font-extrabold text-center">
...
//                             id="name"
//                             name="name"
//                             className="w-full px-4 py-3 border rounded-lg shadow-inner focus:outline-none focus:ring-4 focus:ring-purple-500 dark:bg-gray-700 dark:text-white"
//                             placeholder="Name here"
//                         />
//                     </div>
//                     <div className="mb-6">
...
//                             id="roomId"
//                             name="roomId"
//                             className="w-full px-4 py-3 border rounded-lg shadow-inner focus:outline-none focus:ring-4 focus:ring-pink-500 dark:bg-gray-700 dark:text-white"
//                             placeholder="Room ID here"
//                         />
//                     </div>
...
//                         <button
//                             type="submit"
//                             className="px-6 py-3 bg-purple-600 text-white rounded-lg shadow-lg transform transition-transform hover:scale-105 hover:bg-purple-500 focus:outline-none focus:ring-4 focus:ring-purple-500"
//                         >
//                             Join Room
//                         </button>
//                         <button
//                             type="button"
//                             className="px-6 py-3 bg-green-600 text-white rounded-lg shadow-lg transform transition-transform hover:scale-105 hover:bg-green-500 focus:outline-none focus:ring-4 focus:ring-green-500"
//                         >
//                             Create Room
//                         </button>
//                     </div>
